  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
      <motion.div
        ...
        className="w-full max-w-lg stellar-glass border border-white/10 p-8 relative overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.8)]"
      >
        {/* Glow ambient light */}
        ...
        <div className="flex justify-between items-center mb-6 relative z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-black text-white">Generate Attendance OTP</h2>
              <p className="text-xs text-slate-400">Create a secure, time-expiring attendance code</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        {!generatedSession ? (
          ...
          <form onSubmit={handleGenerate} className="space-y-5 relative z-10">
            <div>
              ...
              {events && events.length > 0 ? (
                <select
                  ...
                  className="stellar-input bg-[#0f172a] text-white border-white/10 cursor-pointer"
                  required
                >
                  {events.map((ev) => (
            ...
            <div>
              <label className="stellar-label">Session Name / Description</label>
              <input
                type="text"
                value={sessionName}
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full stellar-btn flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
          ...
          <div className="space-y-6 text-center relative z-10">
            <div className="p-6 rounded-3xl bg-linear-to-b from-blue-500/10 to-indigo-500/5 border border-blue-500/30">
              ...
              <div className="text-5xl md:text-6xl font-black font-mono tracking-[0.3em] text-white my-4 drop-shadow-[0_0_25px_rgba(59,130,246,0.6)]">
            ...
            <div className="text-left bg-white/5 p-4 rounded-2xl border border-white/5 space-y-1 text-xs text-slate-400">
              <p>
                <span className="text-white font-bold">Session:</span> {generatedSession.sessionName}
              </p>
              <p>
                <span className="text-white font-bold">Instruction:</span> Instruct students to enter this code in the Attendance tab of their dashboard to verify presence.
              </p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="stellar-btn-outline px-6 text-xs font-bold"
              >
                Generate Another
              </button>
            </div>
